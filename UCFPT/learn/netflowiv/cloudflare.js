...
(function() {
    ...
    function Ne(e, r) {
        ...
        function p(f) {
            ...
            a; )
                try {
                    if (o = 1,
                    c && (u = f[0] & 2 ? c.return : f[0] ? c.throw || ((u = c.return) && u.call(c),
                    0) : c.next) && !(u = u.call(c, f[1])).done)
                        return u;
                    switch (c = 0,
                    u && (f = [f[0] & 2, u.value]),
                    f[0]) {
    ...
    var Qt = function(e) {
        var r, a, o = e.state === xe.FAILURE_FEEDBACK || e.state === xe.FAILURE_HAVING_TROUBLES, c, u = L(xr, (c = (r = e.displayLanguage) === null || r === void 0 ? void 0 : r.toLowerCase()) !== null && c !== void 0 ? c : "nonexistent"), g, _ = L(wr, (g = (a = e.displayLanguage) === null || a === void 0 ? void 0 : a.toLowerCase()) !== null && g !== void 0 ? g : "nonexistent");
    ...
    function gt() {
        ...
        if (P(r, HTMLScriptElement) && e.test(r.src))
            return r;
    ...
    function ar() {
        ...
        var a = e.src
          , o = a.split("?");
        return o.length > 1 && (r.params = new URLSearchParams(o[1])),
        r
    }
    function W() {
    ...
    var _t = function(e, r) {
        var a = vt(r.params, !1), o = "h/".concat("b", "/"), c, u, g = "".concat(a, "/cdn-cgi/challenge-platform/").concat(o, "feedback-reports/").concat(Ve(e), "/").concat(r.displayLanguage, "/").concat((c = r.params.theme) !== null && c !== void 0 ? c : r.theme);
        ...
        p.className = "cf-turnstile-feedback",
        p.id = "cf-fr-id",
        p.style.width = "450px",
        p.style.height = Qt(r),
        p.style.position = "relative",
        p.style.zIndex = "21474836420",
        ...
        b.style.width = "26px",
        b.style.height = "26px",
        b.style.zIndex = "21474836421",
        b.style.cursor = "pointer",
        r.displayRTL ? b.style.left = "6px" : b.style.right = "2px",
        b.style.top = "5px",
        ...
        A.setAttribute("ry", "12"),
        A.setAttribute("rx", "12"),
    ...
    function Ir(e) {
        ...
        try {
            for (var c = e.widgetMap[Symbol.iterator](), u; !(r = (u = c.next()).done); r = !0) {
                var g = be(u.value, 2), _ = g[0], p = g[1], f;
                p.watchcat.seq = e.watchCatSeq,
                p.watchcat.lastAckedSeq === 0 && (p.watchcat.lastAckedSeq = e.watchCatSeq);
                var b = K(_);
                if (!b || !p.shadow) {
                    p.watchcat.missingWidgetWarning || (E("Cannot find Widget ".concat(b, ", consider using turnstile.remove() to clean up a widget.")),
    ...
    function Tt() {
        var e = [Wt, Ht];
        h.isRecaptchaCompatibilityMode && e.push(Bt),
    ...
    function vr(e, r) {
        ...
        if (o !== null && P(o, HTMLInputElement) && (o.value = r),
    ...
    var Rt = function() {
        var e = function(n, i, t, d) {
          ...
          , r = function(n, i, t) {
            if (n.params.retry === fe.AUTO || t) {
                n.isExecuted && (n.msgQueue.push(le.EXECUTE),
                n.isExecuted = !0,
                n.isExecuting = !0);
          ...
          , o = function(n) {
            if (!n)
                return [];
            for (var i = n.attributes, t = i.length, d = new Array(t), s = 0; s < t; s++)
                d[s] = i[s].name;
            return d
        }
          , c = function(n, i, t) {
          ...
          , u = function() {
            var n = "abcdefghijklmnopqrstuvwxyz0123456789", i = n.length, t;
            do {
                t = "";
                for (var d = 0; d < 5; d++)
          ...
          , p = function(n, i) {
            if (i) {
                ...
                i.action && (nt(i.action) || v('Invalid input for optional parameter "action", got "'.concat(i.action, '"'), 3604),
                n.action = i.action),
                i.cData && (it(i.cData) || v('Invalid input for optional parameter "cData", got "'.concat(i.cData, '"'), 3605),
                n.cData = i.cData),
          ...
          , f = function(n) {
            ...
            if (t) {
                ...
                t.watchcat.seq = 0,
                t.params.execution === pe.RENDER && (t.msgQueue.push(le.EXECUTE),
                t.isExecuted = !0,
                t.isExecuting = !0);
                var d = K(i)
                  , s = t.shadow.querySelector("#".concat(d));
                (!d || !s) && v("Widget ".concat(i, " to reset was not found."), 3330),
                t.params.appearance === X.INTERACTION_ONLY && dr(s),
                t.params.sitekey === null && v("Unexpected Error: Sitekey is null", 3347);
                var m;
                s.src = mt(i, t.params.sitekey, t.params, (m = t.rcV) !== null && m !== void 0 ? m : Y, !1, "b", ft(t)),
                bt(d),
          ...
          , A = function(n, i) {
            ...
            if (typeof n == "string")
                ...
                P(n, HTMLElement) ? m = n : v('Invalid type for parameter "container", expected "string" or an implementation of "HTMLElement"', 3587);
            var w = Nr(m);
            if (w) {
                var l = Object.assign(w, i), T = l.action, M = l.cData, q = l.chlPageData, U = l.sitekey, C;
                ...
                typeof U != "string" && v('Invalid or missing type for parameter "sitekey", expected "string", got "'.concat(typeof U == "undefined" ? "undefined" : F(U), '"'), 3588),
                Dt(U) || v('Invalid input for parameter "sitekey", got "'.concat(U, '"'), 3589),
                ot(l.size) || v('Invalid type for parameter "size", expected normal|compact, got "'.concat(l.size, '" ').concat(F(l.size)), 3590),
                et(l.theme) || v('Invalid type for parameter "theme", expected dark|light|auto, got "'.concat(l.theme, '" ').concat(F(l.theme)), 3591),
                tt(l.retry) || v('Invalid type for parameter "retry", expected never|auto, got "'.concat(l.retry, '" ').concat(F(l.retry)), 3592),
                l.language || (l.language = "auto"),
                lt(l.language) || (E('Invalid language value: "'.concat(l.language, ", expected either: auto, or an ISO 639-1 two-letter language code (e.g. en) or language and country code (e.g. en-US)")),
                l.language = "auto"),
                st(l.appearance) || v('Unknown appearance value: "'.concat(l.appearance, ", expected either: 'always', 'execute', or 'interaction-only'."), 3600),
                dt(l.execution) || v('Unknown execution value: "'.concat(l.execution, ", expected either: 'render' or 'execute'."), 3601),
                rt(l["retry-interval"]) || v('Invalid retry-interval value: "'.concat(l["retry-interval"], ', expected an integer value > 0 and < 900000"'), 3602),
                at(l["expiry-interval"]) || v('Invalid expiry-interval value: "'.concat(l["expiry-interval"], ', expected an integer value > 0 and < 360000"'), 3602);
                ...
                H.style.margin = "0",
                H.style.padding = "0",
                nt(T) || v('Invalid input for optional parameter "action", got "'.concat(T, '"'), 3604),
                it(M) || v('Invalid input for optional parameter "cData", got "'.concat(M, '"'), 3605);
                var ce = u()
                  , J = K(ce);
                if (!(!ce || !J)) {
                    var Ee = []
                      , ze = l.execution === pe.RENDER;
                    ze && Ee.push(le.EXECUTE),
                    h.lastWidgetIdx++;
                    var mr = {};
                    ...
                    Ge || v("Turnstile Initialization Error ", 3606),
                    N.style.display = "none",
                    N.style.border = "none",
                    N.style.overflow = "hidden",
                    N.setAttribute("src", mt(ce, U, l, Y, !1, "b", ft(Ge))),
                    N.onerror = function() {
                        if (Q) {
                    ...
                    ;
                    var It = ["cross-origin-isolated", "fullscreen", "autoplay"], Xe;
                    L((Xe = (d = document.featurePolicy) === null || d === void 0 || (t = d.features) === null || t === void 0 ? void 0 : t.call(d)) !== null && Xe !== void 0 ? Xe : [], pt) && It.push(pt),
                    N.setAttribute("allow", It.join("; ")),
                    N.setAttribute("sandbox", "allow-same-origin allow-scripts allow-popups"),
                    N.id = J;
                    var Ye;
                    N.tabIndex = (Ye = l.tabindex) !== null && Ye !== void 0 ? Ye : 0,
                    ...
                    if (gr) {
                        ...
                        Ae.type = "hidden";
                        var Qe;
                        if (Ae.name = (Qe = l["response-field-name"]) !== null && Qe !== void 0 ? Qe : qt,
                        Ae.id = "".concat(J, "_response"),
                        H.appendChild(Ae),
                        typeof l["response-field-name"] != "string" && Cr(U)) {
                            var Ie = document.createElement("input");
                            Ie.type = "hidden",
                            Ie.name = jt,
                            Ie.id = "".concat(J, "_legacy_response"),
                            H.appendChild(Ie)
                        }
                    }
                    if (h.isRecaptchaCompatibilityMode) {
                        ...
                        Se.type = "hidden",
                        Se.name = zt,
                        Se.id = "".concat(J, "_g_response"),
                        H.appendChild(Se)
                    }
                    return m.appendChild(H),
                    Ge.widgetRenderEndTimeMs = W(),
                    J
                }
            }
        }
          , S = function() {
            var n, i = -1, t = !0, d = !1, s = void 0;
            try {
        ...
        function R() {
            return R = Ot(function(y, n, i, t) {
                ...
                return Ne(this, function(C) {
                    switch (C.label) {
                    case 0:
                        if (d = y.params.sitekey,
                        s = fr(),
                        !s)
                            return E("Cannot determine Turnstile's embedded location, aborting clearance redemption."),
                            a(y, n, !1),
                            [2];
                        m = "h/".concat("b", "/"),
                        x = new URL(s),
                        w = "https",
                        l = "",
                        T = "".concat(w, "://").concat(x.host, "/cdn-cgi/challenge-platform/").concat(m, "rc/").concat(t).concat(l),
                        C.label = 1;
                    case 1:
                    ...
                    case 2:
                        return M = C.sent(),
                        M.status === 200 ? [3, 3] : (E("Cannot determine Turnstile's embedded location, aborting clearance redemption, are you running Turnstile on a Cloudflare Zone?"),
                        a(y, n, !1),
                        [3, 5]);
                    case 3:
                        return [4, M.json()];
                    ...
                    case 6:
                        return U = C.sent(),
                        E("Error contacting Turnstile, aborting clearance remdeption."),
                        a(y, n, !1),
                        [3, 7];
                    case 7:
                        return [2]
                ...
                if (!(!n.widgetId || !h.widgetMap.has(n.widgetId))) {
                    ...
                    if (!(!i || !t))
                        ...
                        case "init":
                            {
                                ...
                                t.mode = n.mode,
                                t.nextRcV = n.nextRcV,
                                t.mode === B.INVISIBLE && t.params["refresh-expired"] === Z.MANUAL && E("refresh-expired=manual is impossible in invisible mode, consider using '".concat(Z.AUTO, "' or '").concat(Z.NEVER, "'")),
                                t.mode !== B.MANAGED && t.params["refresh-timeout"] !== ue.AUTO && E("setting refresh-timeout has no effect on an invisible/non-interactive widget and will be ignored."),
                                t.params.appearance === X.ALWAYS || t.isExecuting && t.params.appearance === X.EXECUTE ? xt(s, t) : dr(s),
                                s.style.display = "";
                        ...
                        case "translationInit":
                            {
                                ...
                                Object.keys(n.translationData).forEach(function(Ee) {
                        ...
                        case "languageUnsupported":
                            {
                                E("Language ".concat(t.params.language, " is not supported, falling back to: ").concat(n.fallback)),
                        ...
                        case "reject":
                            {
                                ...
                                if (t.isExecuting = !1,
                                l || v("Cannot initialize Widget, Element not found (#".concat(i, ")."), 3075),
                        ...
                        case "fail":
                            {
                                ...
                                if (M) {
                                    var te;
                                    M(String((te = n.code) !== null && te !== void 0 ? te : Ft)) ? t.params.retry === fe.AUTO && !t.isResetting && r(t, i, q) : (n.code && E("Error: ".concat(n.code)),
                                    r(t, i, q))
                                } else
                                    n.code ? (r(t, i, q),
                                    v("Error: ".concat(n.code), 3076)) : r(t, i, !1);
                                break
                            }
                        case "feedbackInit":
                            {
                        ...
                        case "requestFeedbackData":
                            {
                                ...
                                de || v("Received state for an unknown widget: #".concat(i, " / ").concat(n.widgetId), 3078),
                        ...
                        case "turnstileResults":
                            {
                                ...
                                Te || v("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                (ne = Te.contentWindow) === null || ne === void 0 || ne.postMessage({
                                    source: V,
                                    widgetId: n.widgetId,
                                    event: "feedbackData",
                                    rayId: n.rayId,
                        ...
                        case "closeFeedbackReportIframe":
                            {
                                ...
                                je || v("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                nr("".concat(i, "-fr"));
                                break
                            }
                        case "tokenExpired":
                            {
                                var he, qe = n.token;
                                t.isExpired = !0,
                                (he = t.cbExpired) === null || he === void 0 || he.call(t, qe),
                                t.params["refresh-expired"] === Z.AUTO && !t.isResetting && f(i);
                                break
                            }
                        case "interactiveTimeout":
                            {
                                ...
                                bt(i);
                                var Q = t.cbTimeout;
                                if (Q ? Q() : t.params["refresh-timeout"] === ue.NEVER && !t.isResetting && E("The widget encountered an interactive timeout and is set to never refresh. Consider defining a timeout handler and resetting the widget upon timeout as solving a widget in a timed-out state is going to fail."),
                                t.params["refresh-timeout"] === ue.AUTO && !t.isResetting) {
                        ...
                        case "interactiveBegin":
                            {
                                ...
                                G || v("Cannot layout widget, Element not found (#".concat(i, ")."), 3076),
                                (ie = t.cbBeforeInteractive) === null || ie === void 0 || ie.call(t),
                                t.params.appearance === X.INTERACTION_ONLY && xt(G, t);
                                break
                            }
                        case "interactiveEnd":
                            {
                        ...
                        case "requestExtraParams":
                            {
                                ...
                                N || v("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                t.isResetting = !1;
                                var H = {}
                                  , Re = W()
                                  , ce = {
        ...
        return $e(Ce({}, j), {
            ready: function(n) {
                if (h.scriptWasLoadedAsync && (E("turnstile.ready() would break if called *before* the Turnstile api.js script is loaded by visitors"),
                v("Remove async/defer from the Turnstile api.js script tag before using turnstile.ready().", 3857)),
                typeof n != "function" && v('turnstile.ready() expected a "function" argument, got "'.concat(typeof n == "undefined" ? "undefined" : F(n), '"'), 3841),
                h.isReady) {
                    n();
                    return
                }
            ...
            execute: function(n, i) {
                ...
                if (s) {
                    ...
                    if (s.response) {
                        var x;
                        s.isExecuting = !1,
                        E("Call to execute() on a widget that was already executed (".concat(m, "), execute() will return the previous token obtained. Consider using reset() before execute() to obtain a fresh token")),
                        (x = s.cbSuccess) === null || x === void 0 || x.call(s, s.response, !1);
                        return
                    }
                    s.isExpired && E("Call to execute on a expired-widget (".concat(m, "), consider using reset() before")),
                    s.isStale && (f(m),
                    s.isExecuting = !0),
                    s.msgQueue.push(le.EXECUTE),
                    s.isExecuted = !0;
                    var w = s.shadow.querySelector("#".concat(m));
                    if (w || (s.isExecuting = !1,
                    v("Widget ".concat(m, " to execute was not found"), 43522)),
                    s.isResetting)
                        return;
                    if (s.isInitialized && _(s, t, w),
                    s.isInitialized && s.params.appearance === X.EXECUTE && xt(w, s),
                    s.isExecuting) {
                        var l, T = s.shadow.querySelector("#".concat(m));
                        T || v("Received state for an unknown widget: ".concat(t), 3078),
                        (l = T.contentWindow) === null || l === void 0 || l.postMessage({
                            source: V,
                            widgetId: t,
                            event: "execute"
                        }, "*")
            ...
            getResponse: function(n) {
                ...
                if (typeof n == "undefined") {
                    ...
                    if (t) {
                        ...
                        return s != null && s.isExpired && E("Call to getResponse on a widget that expired, consider refreshing the widget."),
                        (d = h.widgetMap.get(t)) === null || d === void 0 ? void 0 : d.response
                    } else
                        v("Could not find a widget", 43794)
                }
                var m = O(n);
                return m || v("Could not find widget for provided container", 43778),
                (i = h.widgetMap.get(m)) === null || i === void 0 ? void 0 : i.response
            },
    ...
    function Nr(e) {
        ...
        if (u && (ot(u) ? a.size = u : E('Unknown data-size value: "'.concat(u, '"'))),
        0)
            var g;
        ...
        i ? (Ut(i) || E('Invalid data-feedback-enabled value: "'.concat(i, ", expected either: 'true' or 'false'. Value is ignored.")),
        a["feedback-enabled"] = i === "true") : a["feedback-enabled"] = !0;
        ...
        return x && (st(x) ? a.appearance = x : E('Unknown data-appearance value: "'.concat(x, ", expected either: 'always', 'execute', or 'interaction-only'."))),
        a
    }
    function kr() {
        var e = !0;
        ...
        ur(window.turnstile, h)
    }
    ve = !1,
    I = ar(),
    h.scriptWasLoadedAsync = (We = I == null ? void 0 : I.loadedAsync) !== null && We !== void 0 ? We : !1,
    I != null && I.params && (me = I.params.get("compat"),
    (me == null ? void 0 : me.toLowerCase()) === "recaptcha" ? window.grecaptcha ? E("grecaptcha is already defined. The compatibility layer will not be enabled") : (E("Compatibility layer enabled"),
    h.isRecaptchaCompatibilityMode = !0,
    window.grecaptcha = Rt) : me !== null && E('Unknown value for api.js?compat: "'.concat(me, '", ignoring')),
    I.params.forEach(function(e, r) {
        L(["onload", "compat", "_cb", "_upgrade", "_reload", "render"], r) || E('Unknown parameter passed to api.js: "?'.concat(r, '=...", ignoring'))
    }),
    ve = I.params.get("_upgrade") === "true",
    z = I.params.get("onload"),
    z && !ve && setTimeout(function() {
        typeof window[z] == "function" ? window[z]() : (E("Unable to find onload callback '".concat(z, "' immediately after loading, expected 'function', got '").concat(F(window[z]), "'")),
        setTimeout(function() {
    ...
    wt = "turnstile"in window,
    wt && !ve ? E("Turnstile already has been loaded. Was Turnstile imported multiple times?") : (wt && ve && (lr(window.turnstile, h),
    yt(h),
    (I == null || (He = I.params) === null || He === void 0 ? void 0 : He.get("render")) !== "explicit" && setTimeout(Tt, 0)),
    window.turnstile = Rt,
    ve || ((I == null || (Be = I.params) === null || Be === void 0 ? void 0 : Be.get("render")) !== "explicit" && At.push(Tt),
    document.readyState === "complete" || document.readyState === "interactive" ? setTimeout(sr, 0) : window.addEventListener("DOMContentLoaded", sr))),
    pr = 24 * 60 * 60 * 1e3,
    window.setTimeout(kr, pr);
