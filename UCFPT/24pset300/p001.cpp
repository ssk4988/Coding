...
ll getocc(int t, ll a, ll lim = 1e10){
    ...
    ll higherbound = lo;
    // cout << "lowerbound is " << lowerbound << " higherbound is " << higherbound << nL;
    return calc(t, lowerbound) == a && lowerbound <= lim;
...
int main()
{
    ...
    // cout << sum << nL;
    rep(i, 0, n){
        // cout << (grumbers[i] ^ sum) << " " << grumbers[i] << nL;
        rep(t, 0, 3){
            ll cont = getocc(t, grumbers[i] ^ sum, maxb(t, ts[i], as[i]));
            // cout << i << " " << ts[i] << " " << as[i] << " " << maxb(t, ts[i], as[i]) << " " << cont << nL;
            ans += cont;
        }
    }
    cout << ans << nL;
    // cout << calc(0, 6) << " " << calc(1, 10) << " " << calc(2, 11) << nL;
