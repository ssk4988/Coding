...
public class prob8 {
	...
	// The head will always be the first item to intersect the target, so just check
	// that!
	...
	public static int getSnake() {
		...
		// Build the rest of the mask: 0 = up, 1 = left, 2 = right, 3 = down. (stored in
		// OFFSET)
		for (int i = 1; i < n; i++) {
